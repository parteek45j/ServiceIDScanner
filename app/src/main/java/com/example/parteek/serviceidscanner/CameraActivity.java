package com.example.parteek.serviceidscanner;
...
public class CameraActivity extends AppCompatActivity {
    ...
    void showDialouge(){
        ...
        AppCompatButton appCompatButton1=null;
        ...
        appCompatButton=(AppCompatButton)dialog.findViewById(R.id.share);
        appCompatButton1=(AppCompatButton)dialog.findViewById(R.id.cancel);
        imageView=(ImageView) dialog.findViewById(R.id.qrcode);
